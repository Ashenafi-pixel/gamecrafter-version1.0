    ...
    <div className={`w-full h-full flex flex-col ${className}`}>
      ...
      <div className="flex-grow relative">
        ...
        <div className="absolute right-0 top-[10%] bottom-[12%] w-14 flex flex-col justify-between items-center z-50 pointer-events-auto">
          ...
          <button 
            className="h-10 w-10 mx-auto rounded-full bg-zinc-800 text-white flex items-center justify-center shadow-lg hover:bg-zinc-700 transition-colors"
          ...
          <button 
            className="h-12 w-12 mx-auto rounded-full bg-white text-black flex items-center justify-center shadow-xl transform hover:scale-105 transition-all duration-200"
            onClick={onSpin}
            aria-label="Spin"
          >
      ...
      <div className="flex-shrink-0 flex flex-col">
        ...
        <div className="h-[22px] bg-black/80 text-white text-xs px-2 flex items-center justify-start rounded-b-md shadow-inner z-40">
